...
def fetch_resources_from_db():
    try:
        return list(collection.find({"type": "resource"}))
    except Exception:
        return []
...
with tab_sc:
    ...
    with st.expander("📌 KPI Target & Scoring Scale Matrix Reference"):
        st.markdown(
            ...
            | **QA** | **90.0%** | $\ge$ 98.0% | 96.5% - 97.9% | 90.0% - 96.4% | 85.0% - 89.9% | < 85.0% |
...
with tab_adm:
    ...
    if not st.session_state.admin_authenticated:
        ...
        with col_right:
            ...
            all_rejected_source = global_rejected_requests + rtm_rejected_requests
